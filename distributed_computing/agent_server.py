"""In this file, you need to implement a remote procedure call (RPC) server.
...
* The following functions have to be implemented and exported:
  ...
  * get_transform
  * set_transform
* You can test the RPC server with IPython before implementing agent_client.py
"""
...
class ServerAgent(InverseKinematicsAgent):
    ...
    def get_angle(self, joint_name):
        # Get the angle of the joint from perception
        """Get the sensor value of the given joint."""
    ...
    def get_transform(self, name):
        # Get the transform with the given name
        """Get the transform with the given name."""
